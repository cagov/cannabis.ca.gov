...
function placeStatusTooltipMessage(data, props, options) {
  ...
  let output = `<div>
          ...
          <div>
            <p>
              <a class="loadPlace" href="#">${detailsCTA}</a>
            </p>
          </div>
        </div>`;
