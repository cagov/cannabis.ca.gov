...
export class ComboBox {
  ...
  create() {
    fs.readFile(this.placesFileName, (err, data) => {
      ...
      this.templateHMTL += `<!-- Start cagov-combobox-places -->
      <div class="cagov-combobox-places">
        <label class="combobox-places--label filter-label" for="cb1-input">Enter a city or county</label>
        <div class="combobox-places--group">
          <input id="cb1-input" class="combobox-places--combobox" type="text" role="combobox" aria-autocomplete="both" aria-expanded="false" aria-haspopup="true" aria-owns="lb1"  placeholder="Enter a city or county"/>
        ...
        <ul id="lb1" class="combobox-places--listbox" role="listbox" aria-label="States">`;
