...
const { copyFolderRecursiveSync } = require("./src/js/eleventy/sync-static-content.js");
const { renderPostLists, renderWordpressPostTitleDate } = require("./src/js/eleventy/post-list/render.js");
...
module.exports = function (eleventyConfig) {
  ...
  eleventyConfig.addFilter("changeWpMediaPath", (path) => path.replace(
